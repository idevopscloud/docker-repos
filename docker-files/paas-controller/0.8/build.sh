...
workdir=/tmp/idevops/workdir/paas-controller-docker
...
cd $workdir
wget ${package_server}/paas-controller/paas-controller-${version}.tar.gz
gunzip paas-controller-${version}.tar.gz
mv paas-controller-${version}.tar paas-controller.tar
...
docker build -t $registry/idevops/paas-controller:$version ./
